...
Source0  : http://mirror.netcologne.de/xfce/src/panel-plugins/xfce4-whiskermenu-plugin/2.1/xfce4-whiskermenu-plugin-2.1.2.tar.bz2
...
%prep
%setup -q -n xfce4-whiskermenu-plugin-2.1.2
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1496189518
mkdir clr-build
pushd clr-build
