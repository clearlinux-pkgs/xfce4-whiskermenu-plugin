...
Source0  : https://archive.xfce.org/src/panel-plugins/xfce4-whiskermenu-plugin/2.9/xfce4-whiskermenu-plugin-2.9.0.tar.bz2
...
%prep
%setup -q -n xfce4-whiskermenu-plugin-2.9.0
cd %{_builddir}/xfce4-whiskermenu-plugin-2.9.0
%patch -P 1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1738261343
mkdir -p clr-build
pushd clr-build
