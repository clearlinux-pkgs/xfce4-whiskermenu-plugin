...
Version  : 2.1.4
Release  : 14
URL      : http://mirror.netcologne.de/xfce/src/panel-plugins/xfce4-whiskermenu-plugin/2.1/xfce4-whiskermenu-plugin-2.1.4.tar.bz2
Source0  : http://mirror.netcologne.de/xfce/src/panel-plugins/xfce4-whiskermenu-plugin/2.1/xfce4-whiskermenu-plugin-2.1.4.tar.bz2
...
%prep
%setup -q -n xfce4-whiskermenu-plugin-2.1.4
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1512140886
mkdir clr-build
pushd clr-build
