...
Source0  : https://archive.xfce.org/src/panel-plugins/xfce4-whiskermenu-plugin/2.7/xfce4-whiskermenu-plugin-2.7.2.tar.bz2
...
%prep
%setup -q -n xfce4-whiskermenu-plugin-2.7.2
cd %{_builddir}/xfce4-whiskermenu-plugin-2.7.2
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1674060210
mkdir -p clr-build
pushd clr-build
