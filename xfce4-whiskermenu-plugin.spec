...
Source0  : http://mirror.netcologne.de/xfce/src/panel-plugins/xfce4-whiskermenu-plugin/1.5/xfce4-whiskermenu-plugin-1.5.1.tar.bz2
...
%prep
%setup -q -n xfce4-whiskermenu-plugin-1.5.1
