...
%prep
%setup -q -n xfce4-whiskermenu-plugin-2.3.4
cd %{_builddir}/xfce4-whiskermenu-plugin-2.3.4
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572992630
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/xfce4-whiskermenu-plugin-2.3.4/COPYING %{buildroot}/usr/share/package-licenses/xfce4-whiskermenu-plugin/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
