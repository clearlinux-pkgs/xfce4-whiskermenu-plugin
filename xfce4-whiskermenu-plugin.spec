...
Source0  : http://archive.xfce.org/src/panel-plugins/xfce4-whiskermenu-plugin/2.3/xfce4-whiskermenu-plugin-2.3.1.tar.bz2
...
%prep
%setup -q -n xfce4-whiskermenu-plugin-2.3.1
%patch1 -p1
...
export LANG=C
export SOURCE_DATE_EPOCH=1550195078
mkdir -p clr-build
pushd clr-build
%cmake ..
