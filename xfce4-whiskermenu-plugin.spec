...
Version  : 2.5.0
Release  : 30
URL      : https://archive.xfce.org/src/panel-plugins/xfce4-whiskermenu-plugin/2.5/xfce4-whiskermenu-plugin-2.5.0.tar.bz2
Source0  : https://archive.xfce.org/src/panel-plugins/xfce4-whiskermenu-plugin/2.5/xfce4-whiskermenu-plugin-2.5.0.tar.bz2
...
%prep
%setup -q -n xfce4-whiskermenu-plugin-2.5.0
cd %{_builddir}/xfce4-whiskermenu-plugin-2.5.0
%patch1 -p1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1609288671
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/xfce4-whiskermenu-plugin-2.5.0/COPYING %{buildroot}/usr/share/package-licenses/xfce4-whiskermenu-plugin/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
